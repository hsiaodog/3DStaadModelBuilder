...
const _I18N = {
  ...
  "tools.structurePipeline":  { "zh-TW": "結構 Pipeline 管理…", "en": "Structure Pipeline…" },
  ...
  "sb.structureType":   { "zh-TW": "結構類型",       "en": "Structure Type" },
  "sb.structureManage": { "zh-TW": "管理…",          "en": "Manage…" },
  "sb.structureTypeHelp": { "zh-TW": "選定後「⚡ 3D 一鍵處理」會依此結構類型的 pipeline 編排節點 / 桿件。", "en": "“⚡ Run 3D Pipeline” will number joints / members using the selected structure type’s pipeline." },
  ...
  "p3d.structureType":           { "zh-TW": "結構類型:",         "en": "Structure:" },
  "p3d.structureManage":         { "zh-TW": "管理…",              "en": "Manage…" },
